...
function edamam_recipe_format_recipe($recipe) { //!!mwp
  global $wpdb;
	...
	$output .= '
        ...
        if($logo == "yes"){
          $logostr = '<span style="float:right;"><a target="_blank" href="https://www.edamam.com/nutrition_wizard/"><img src="' . EDAMAM_RECIPE_PLUGIN_DIRECTORY . 'edamam-logo-plugin.png" class="edamam-img"></a></span>';
        } 
        ...
        if (strcmp($edamamAPI, '') != 0) {
          ...
          if($record->servings == null){
            ...
            <div id="edamam-not-nutritional">
              See more about Edamam on<br/><a target="_blank" href="https://www.edamam.com/nutrition_wizard/"><img src="' . EDAMAM_RECIPE_PLUGIN_DIRECTORY . 'logo-plugin-big.png" class="edamam-img"></a>
            </div>';
